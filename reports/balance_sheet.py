...
if __name__ == '__main__':
    ...
    from ..reports.income_statement import income_statement
    from ..reports.shareholders_equity import shareholders_equity
    from ..reports.balance_sheet import balance_sheet
    ...
    statements['equity'] = shareholders_equity(BigDog, 'Monthly',
                                               datetime(2001, 2, 3, 4, 5))
